...
extern void __FASTCALL__ VT_Setup (void);
//1 plays once   2 plays endlessly
extern void __FASTCALL__ VT_START (void);
extern void __FASTCALL__ VT_INIT (void);
extern void __FASTCALL__ VT_PLAY (void);
extern void __FASTCALL__ VT_MUTE (void);
extern unsigned char VT_SONG; //attention new
extern unsigned char VT_LOOP; //attention new
//attention new
